...
<PopoverContent align={align} className="w-[90vw] sm:w-[520px] p-0">
  <div className="p-4">
    {/* Controls Section */}
...
<style jsx>{`
  /* Force single-month view even if DayPicker defaults to two in range mode */
  .single-month :global(.rdp-months) > :not(:first-child) { display: none; }
  .single-month :global(.rdp-months) { width: 100%; }
`}</style>
{/* Removed oversized calendar overrides to use compact defaults */}
    </Popover>
  )
}
