...
import { ArrowLeft, CalendarIcon, Check, Loader2, Package, Save, Search } from "lucide-react"
  ...
  return (
    <div className={"p-8"}>
      <AdminPageHeader
        ...
        description={"Configure a new pack pool (banner)."}
        title={"Create Pool"}
      />
            ...
            <div className={"ml-auto text-right"}>
              ...
              <Input
                ...
                onChange={(e) => {
                  ...
                  // Rechunk groups when active count changes in manual mode
